  ...
  <div class="main"> 
    ...
    <div class="content">
      ...
      <div class="content1">
		...
		<h2><i>Request for General performance Analysis </i></h2>
			<form action="general report.php" method="post" id="myforms2" onsubmit="return validateForm();" enctype="multipart/form-data" >				
			<table border="0" cellspacing="20px">

			<tr><td>Choose Term: </td> <td><select name="cTerm" >
			...
			<button type="submit" form="myforms2" value="Submit" class="button">Analyze</button>
			</div>
        <div class="clear"></div>
      </div>
    </div>
